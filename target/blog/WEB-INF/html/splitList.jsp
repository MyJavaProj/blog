...
<body>
	...
	<script type="text/javascript">
	$().ready(){
		var currentNum = ${queryModel.getStart()};
		var Count4page = ${queryModel.getPageShow()};
		var allNum = ${queryModel.getTotalCount()};
		var ul = PageSplit(currentNum, allNum, Count4page);
        ...
        function PageSplit(currentNum, allNum, Count4page) {
            ...
            return "<ul>" + startNum + middleNum + endPart +"</ul>";
